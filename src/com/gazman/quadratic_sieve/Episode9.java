...
public class Episode9 extends BaseFact {

    private int B;
    private final List<Integer> primeBase = new ArrayList<>();
    private final List<Wheel2> wheels = new ArrayList<>();
    public static final BigInteger RANGE = BigInteger.valueOf(1000_000);
    ...
    private void addBSmoothValue(BigInteger localPosition, BigInteger N) {
        ...
        if (vector != null) {
            ...
            if(System.nanoTime() - lastUpdateNano > 1_000_000_000){
                ...
                double totalBSmoothValues = primeBase.size() * 0.9;
                ...
                log("Completed", progress, "found", bSmoothFound, "estimated time to finish",
                        (long)((totalBSmoothValues - bSmoothFound) / speedInMilliseconds));
            }
        }
    }
