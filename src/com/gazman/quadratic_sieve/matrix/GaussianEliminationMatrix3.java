...
public class GaussianEliminationMatrix3 {
    ...
    public void add(BSmooth bSmooth) {
        ...
        for (int eliminatorBitIndex = 0; eliminatorBitIndex < bSmooth.vector.size(); eliminatorBitIndex++) {
            if (bSmooth.vector.get(eliminatorBitIndex)) {
                Integer eliminatorIndex = eliminatorsMap.get(eliminatorBitIndex);
    ...
    private void addEliminator(int eliminatorIndex) {
        ...
        if (eliminator.vector.isEmpty()) {
            ...
            int eliminatingBitIndex = extractEliminatorBitIndex(eliminator);
