...
public class GaussianEliminationMatrix {
    ...
    public List<List<BSmooth>> solve(List<BSmooth> bSmoothList, List<BigInteger> primeBase) {
        List<List<BSmooth>> solutions = new ArrayList<>();

        bSmoothList = filerSinglePrimes(bSmoothList, primeBase);
    ...
    private List<BSmooth> filerSinglePrimes(List<BSmooth> bSmoothList, List<BigInteger> primeBase) {
